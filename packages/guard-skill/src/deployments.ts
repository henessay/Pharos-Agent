...
export function loadDeployments(opts: { file?: string } = {}): Deployments {
  ...
  return {
    ...
    rpcUrl: process.env.PHAROS_RPC_URL ?? raw.rpcUrl ?? "https://testnet.dplabs-internal.com",
    explorer: process.env.EXPLORER_URL ?? raw.explorer ?? "https://testnet.pharosscan.xyz",
    treasuryPolicy,
    guardLog,
